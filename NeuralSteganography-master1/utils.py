...
def get_model(seed=1234, model_name='gpt2'):
    ...
    enc = GPT2Tokenizer.from_pretrained('D:/OneDrive - whu.edu.cn/桌面/NeuralSteganography-master1/pretrained_model') # local predownload pretrained_model
    # enc = GPT2Tokenizer.from_pretrained(model_name)
    enc.unk_token = None
    enc.bos_token = None
    enc.eos_token = None
    
    model = GPT2LMHeadModel.from_pretrained('D:/OneDrive - whu.edu.cn/桌面/NeuralSteganography-master1/pretrained_model')
